            ...
            <div>
              ...
              <div className="space-y-6 font-body font-light text-sm text-muted-foreground">
                <div>
                  ...
                  <a href="mailto:hello@archandpetalco.com" className="hover:text-brand-onyx transition-colors">hello@archandpetalco.com</a>
                </div>
                <div>
                  <p className="font-body text-[11px] uppercase tracking-[3px] text-brand-champagne mb-1">Instagram</p>
                  <a href="https://instagram.com/archandpetalco" target="_blank" rel="noopener noreferrer" className="hover:text-brand-onyx transition-colors">@archandpetalco</a>
                </div>
                <div>
